...
export const MathQAInterface = ({ stats, mostPlayedGame, topPerformers, recentGames }) => {
  return (
        ...
        <div className="bg-gradient-to-br from-gray-900/90 to-gray-800/90 rounded-2xl p-6 backdrop-blur border-2 border-purple-500/50">
          ...
          <div className="space-y-2">
            {topPerformers.map((player, i) => (
              <div key={i} className={`flex items-center gap-3 p-4 rounded-xl transition-all hover:scale-102 ${
                i === 0 ? 'bg-gradient-to-r from-yellow-500/30 to-orange-500/30 border-2 border-yellow-500/50 shadow-lg' :
